    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu menuitem-active">
            ...
            <div class="h-100 show" id="leftside-menu-container" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                ...
                <li class="side-nav-item">
                    ...
                    <li class="side-nav-item">
                      <a data-bs-toggle="collapse" href="#sidebarLesson" aria-expanded="false" aria-controls="sidebarLesson" class="side-nav-link">
                          <i class="uil-folder-plus"></i>
                          <span>Manage Lesson</span>
                          <span class="menu-arrow"></span>
                      </a>
                      <div class="collapse" id="sidebarLesson">
                          <ul class="side-nav-second-level">
                              <li>
                                  <a href="apps-email-inbox.php">Progress Reports</a>
                              </li>
        ...
        <div class="content-page">
            ...
            <table id="basic-datatable" class="table table-centered mb-0">
              <div class="row mb-2">
                <div class="col-sm-4">
                    <a href="Teacher_AddStudent.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Student</a>
                </div>
                <div class="col-sm-8">
                    <div class="text-sm-end">
                      <a href="javascript:void(0);" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Enroll Student</a>
                      <a href="javascript:void(0);" class="btn btn-danger mb-2"><i class="uil-edit-alt"></i> Edit</a>
                    </div>
                </div><!-- end col-->
            </div>
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor8">
                            <label class="form-check-label" for="customCheckcolor8">Select</label>
                          </div>
                        </td>
                        <td>0006</td>
                        <td>Reyes, Michael</td>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor9">
                            <label class="form-check-label" for="customCheckcolor9">Select</label>
                          </div>
                        </td>
                        <td>0007</td>
                        <td>Tan, Angela</td>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor10">
                            <label class="form-check-label" for="customCheckcolor10">Select</label>
                          </div>
                        </td>
                        <td>0008</td>
                        <td>Del Rosario, Jose</td>
                        <td>02000221074</td>
                        <td>09/04/2018</td>
                        <td>
                          <button type="button" class="btn btn-danger"><i class="mdi mdi-window-close"></i></button>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor11">
                            <label class="form-check-label" for="customCheckcolor11">Select</label>
                          </div>
                        </td>
                        <td>0009</td>
                        <td>Lim, Karen</td>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor12">
                            <label class="form-check-label" for="customCheckcolor12">Select</label>
                          </div>
                        </td>
                        <td>0010</td>
                        <td>Santos, Ana</td>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor13">
                            <label class="form-check-label" for="customCheckcolor13">Select</label>
                          </div>
                        </td>
                        <td>0011</td>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor14">
                            <label class="form-check-label" for="customCheckcolor14">Select</label>
                          </div>
                        </td>
                        <td>0012</td>
                        <td>Santos, Maria</td>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor15">
                            <label class="form-check-label" for="customCheckcolor15">Select</label>
                          </div>
                        </td>
                        <td>0013</td>
                        <td>Tan, Richard</td>
                      ...
                      <tr>
                        <td>
                          <div class="form-check form-checkbox-success mb-2">
                            <input type="checkbox" class="form-check-input customCheckbox" id="customCheckcolor16">
                            <label class="form-check-label" for="customCheckcolor16">Select</label>
                          </div>
                        </td>
                        <td>0014</td>
                        <td>Gomez, Juan</td>
...
<script>
    // Get the checkbox element by its ID and set the checked attribute to false
    document.getElementById("customCheckcolor2").checked = false;
</script>
