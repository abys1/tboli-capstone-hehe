...
<html lang="en" class="menuitem-active">
    <head>
        <meta charset="utf-8" />
        <title>Teachers Student List</title>
        ...
        <div class="wrapper">
            ...
            <div class="leftside-menu menuitem-active">
                ...
                <div class="h-100 show" id="leftside-menu-container" data-simplebar="init">
                    ...
                    <div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; transform: translate3d(0px, 0px, 0px); display: none;"></div></div>
                </div>
                <!-- Sidebar -left -->
            </div>
            <!-- Left Sidebar End -->
            ...
            <div class="content-page">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">List Of Learners</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                ...
                <div class="end-bar">
                    ...
                    <div class="rightbar-content h-100" data-simplebar="init">
                        ...
                        <div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div>
                        <div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 671px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div>
                    </div>
                </div>
