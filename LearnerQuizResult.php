                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-md-center mt-4">
                        <div class="card col-sm-10">
                            <div class="card-body">
                                <h5 class="card-title h3">Results</h5>
                                <p class="mt-2 text-center h4">You have got 20/30 pts.</p>

                                <div class="card-footer">
                                    <div class="col-sm-12 text-md-end">
                                        <a href="Learner_Module.php"><button class="btn btn-primary">Okay</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
