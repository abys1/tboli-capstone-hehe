                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                <div class="mb-3">
                                        <label for="topicTitle" class="form-label">Teacher</label>
                                        <select class="form-select" id="topicTitle">
                                            <option value="teacher1">Ann</option>
                                            <option value="teacher2">Jennie</option>
                                            <option value="teacher3">Lisa</option>
                                            <option value="teacher4">Jisoo</option>
                                            <option value="teacher5">Rose</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
